...
builder.Services.AddDbContext<ProjectTwoDBContext>(options =>
options.UseSqlServer("name=ConnectionStrings:ConnStr"));
// For Identity 
...
//builder.Services.AddDbContext<ProjectTwoDBContext>(options => options.UseSqlServer(connectionString));
